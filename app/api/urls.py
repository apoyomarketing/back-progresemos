...
from app.usuarios.views import RolViewSet, UsuarioViewSet
from app.candidatos.views import CargoViewSet, CandidatoViewSet
from app.ubicaciones.views import DepartamentoViewSet, ProvinciaViewSet, DistritoViewSet
from app.cms.viewsets import (
